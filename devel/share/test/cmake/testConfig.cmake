...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/kvn/ros/panda_ws/src/test)
  set(test_DEVEL_PREFIX /home/kvn/ros/panda_ws/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/kvn/ros/panda_ws/install)
...
if(NOT "/home/kvn/ros/panda_ws/src/test/include;/home/kvn/libfranka/include " STREQUAL " ")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/kvn/ros/panda_ws/src/test/include;/home/kvn/libfranka/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kvn/ros/panda_ws/src/test/${idir}'.  ${_report}")
    endif()
    _list_append_unique(test_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "actionlib;actionlib_msgs;geometry_msgs;franka_gripper;message_runtime;moveit_msgs;moveit_core;moveit_visual_tools;moveit_ros_planning_interface;roscpp;rospy;sensor_msgs;std_msgs;/home/kvn/libfranka/build/libfranka.so.0.8.0")
