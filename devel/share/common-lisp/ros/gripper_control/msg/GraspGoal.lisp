...
(cl:defclass <GraspGoal> (roslisp-msg-protocol:ros-message)
  ((width
   ...
   (epsilon
    :reader epsilon
    :initarg :epsilon
    :type gripper_control-msg:GraspEpsilon
    :initform (cl:make-instance 'gripper_control-msg:GraspEpsilon))
   (speed
    :reader speed
    :initarg :speed
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <GraspGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gripper_control-msg:<GraspGoal> is deprecated: use gripper_control-msg:GraspGoal instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <GraspGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper_control-msg:width-val is deprecated.  Use gripper_control-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'epsilon-val :lambda-list '(m))
(cl:defmethod epsilon-val ((m <GraspGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper_control-msg:epsilon-val is deprecated.  Use gripper_control-msg:epsilon instead.")
  (epsilon m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <GraspGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper_control-msg:speed-val is deprecated.  Use gripper_control-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'force-val :lambda-list '(m))
(cl:defmethod force-val ((m <GraspGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper_control-msg:force-val is deprecated.  Use gripper_control-msg:force instead.")
  (force m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GraspGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%float64 width # [m]~%GraspEpsilon epsilon~%float64 speed # [m/s]~%float64 force # [N]~%~%================================================================================~%MSG: gripper_control/GraspEpsilon~%float64 inner # [m]~%float64 outer # [m]~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GraspGoal)))
  "Returns full string definition for message of type 'GraspGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%float64 width # [m]~%GraspEpsilon epsilon~%float64 speed # [m/s]~%float64 force # [N]~%~%================================================================================~%MSG: gripper_control/GraspEpsilon~%float64 inner # [m]~%float64 outer # [m]~%~%~%"))
