...
(cl:defmethod cl:initialize-instance :after ((m <GraspEpsilon>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspEpsilon)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gripper_control-msg:<GraspEpsilon> is deprecated: use gripper_control-msg:GraspEpsilon instead.")))

(cl:ensure-generic-function 'inner-val :lambda-list '(m))
(cl:defmethod inner-val ((m <GraspEpsilon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper_control-msg:inner-val is deprecated.  Use gripper_control-msg:inner instead.")
  (inner m))

(cl:ensure-generic-function 'outer-val :lambda-list '(m))
(cl:defmethod outer-val ((m <GraspEpsilon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper_control-msg:outer-val is deprecated.  Use gripper_control-msg:outer instead.")
  (outer m))
