...
(cl:defmethod cl:initialize-instance :after ((m <GraspFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gripper_control-msg:<GraspFeedback> is deprecated: use gripper_control-msg:GraspFeedback instead.")))
