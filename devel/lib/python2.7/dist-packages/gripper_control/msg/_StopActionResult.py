...
"""autogenerated by genpy from gripper_control/StopActionResult.msg. Do not edit."""
import codecs
import sys
...
class StopActionResult(genpy.Message):
  ...
  _type = "gripper_control/StopActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gripper_control/StopResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = gripper_control.msg.StopResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gripper_control.msg.StopResult()
