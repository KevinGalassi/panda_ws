...
"""autogenerated by genpy from gripper_control/HomingActionResult.msg. Do not edit."""
import codecs
import sys
...
class HomingActionResult(genpy.Message):
  ...
  _type = "gripper_control/HomingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gripper_control/HomingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = gripper_control.msg.HomingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gripper_control.msg.HomingResult()
