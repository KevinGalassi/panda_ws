...
"""autogenerated by genpy from gripper_control/GraspActionResult.msg. Do not edit."""
import codecs
import sys
...
class GraspActionResult(genpy.Message):
  ...
  _type = "gripper_control/GraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gripper_control/GraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = gripper_control.msg.GraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gripper_control.msg.GraspResult()
