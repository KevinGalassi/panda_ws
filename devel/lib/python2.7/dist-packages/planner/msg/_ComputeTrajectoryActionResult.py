...
"""autogenerated by genpy from planner/ComputeTrajectoryActionResult.msg. Do not edit."""
import codecs
import sys
...
class ComputeTrajectoryActionResult(genpy.Message):
  _md5sum = "037b5edac7e11639096037efaa3e42c3"
  _type = "planner/ComputeTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','planner/ComputeTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ComputeTrajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = planner.msg.ComputeTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = planner.msg.ComputeTrajectoryResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.FinalTrajectories)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.FinalTrajectories:
        _v1 = val1.header
        _x = _v1.seq
      ...
      length = len(self.result.FinalLabel)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.FinalLabel:
        length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.FinalTrajectories.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.FinalLabel = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.FinalLabel.append(val1)
      return self
